...
class SwinIR(nn.Module):
    ...
    def __init__(self, img_size=64, patch_size=1, upscale=1, img_range=1.,
                 in_chans=1, out_chans=3, embed_dim=96,
        ...
        self.conv_first_ir = nn.Conv2d(1, embed_dim, 1, 1)
        self.conv_first_vi = nn.Conv2d(3, embed_dim, 1, 1)
    ...
    def forward(self, img_a, img_b):
        ...
        x_first = self.conv_first_ir(img_a) + self.conv_first_vi(img_b)
